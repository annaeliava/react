import Heroes from './assets/components/heroes';
  ...
  return (
    <>
      <h1>Супергерои</h1>
      {
        ...
        <Heroes name = {character.name} universe = {character.universe} alterEgo = {character.alterEgo} activity = {character.activity} friends = {character.friends} superPowers = {character.superPowers} pic = {character.pic} description = {character.description} />
        )
      }
    </>
  );
